...
import in.aman.service.ReportService;
...
public class ReportController {
	...
	public void pdfExport(HttpServletResponse response, Model model) throws Exception {
		...
		response.addHeader("Content-Disposition", "attachmnet;filename=plans.pdf");
	...
	public void excelExport(HttpServletResponse response, Model model) throws Exception {
		...
		response.addHeader("Content-Disposition", "attachmnet;filename=plans.xls");
	...
	@PostMapping("/search")
	public String haldleSearch(@ModelAttribute("search") SearchRequest search, Model model) {
